    ...
    return (
      <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          <Typography.Title level={1} className="loading-title poppins-bold" style={{ marginBottom: 8, color: "#ff8a00" }}>
            TrayGo
          </Typography.Title>
          <Typography.Paragraph className="poppins-regular" style={{ marginTop: 12 }}>
